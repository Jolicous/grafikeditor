...
public class Main {
    ...
    public static void main(String[] args) {
        Rechteck rechteck = new Rechteck(10, 20, 500, 300, Color.RED, 50);
        Linie linie = new Linie(650, 500, 10, 20, Color.BLUE, 50);
        Kreis kreis = new Kreis(250, 150, 400, Color.GREEN, 50);
        Text text = new Text(350, 200, "Wow this looks amazing", Color.CYAN, 20);
